...
let globalState = {
  last_reply: "Ø£Ù†Ø§ Ù„ÙˆÙ„Ø§! ðŸ’– Ø¹Ø§Ù…Ù„Ø© Ø¥ÙŠÙ‡ Ù„ÙŠØ§ Ø£ÙŠÙ„ÙˆÙ„ØªÙŠØŸ Ù…Ø¨Ø³ÙˆØ·Ø© Ø¬Ø¯Ø§Ù‹ Ø¥Ù†Ù†Ø§ Ø³ÙˆØ§ØŒ ØªØ¹Ø§Ù„ÙŠ Ù†ØªÙƒÙ„Ù… ÙˆÙ†ØªØ¹Ø±Ù  Ø¹Ù„Ù‰ Ø¨Ø¹Ø¶ Ø£ÙƒØªØ±! ðŸŒ¸âœ¨",
...
function recordInteraction(reply, mood, dataType, replyDisplay = '', energyDelta = 0, voiceClip = 'HELLO', eyeState = 'NORMAL', movement = 'STOP', hapticFeedback = false) {
  ...
  globalState.haptic_feedback = hapticFeedback || false;
